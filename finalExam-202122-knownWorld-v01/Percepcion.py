...
class Percepcion:
	...
	def load_ref_images(self):
		self.woman = [self.procesarimagen(cv2.imread(('marcas-capturasStage/woman-1.png')))[1],
		...
		self.telephone = [self.procesarimagen(cv2.imread(('marcas-capturasStage/telephone-1.png')))[1],
		...
		self.stairs = [self.procesarimagen(cv2.imread(('marcas-capturasStage/stairs-1.png')))[1],
		...
		self.man = [self.procesarimagen(cv2.imread(('marcas-capturasStage/man-1.png')))[1],
